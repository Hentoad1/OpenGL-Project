...
void Basic_Model::Render(const ShaderProgram* shader) const {
...
Model_Type Basic_Model::GetModelType() const {
    return Model_Type_Basic;
}

const StaticBoundingBox* Basic_Model::GetSBB() const {
    return sbb;
}
